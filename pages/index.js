    ...
    <Layout preview={preview}>
      ...
      <Container>
        <div className="flex justify-center md:justify-end mb-16">
          ...
          <label htmlFor="wordpress-toggle" className="ml-3 inline-flex relative items-center cursor-pointer">
          ...
          <label htmlFor="workplaces-toggle" className="ml-3 inline-flex relative items-center cursor-pointer">
          ...
          <label htmlFor="twitter-toggle" className="ml-3 inline-flex relative items-center cursor-pointer">
          ...
          {/* <label htmlFor="portfolio-toggle" className="ml-3 inline-flex relative items-center cursor-pointer">
          ...
          <label htmlFor="instagram-toggle" className="ml-3 inline-flex relative items-center cursor-pointer">
